...
public class InMobiInterstitialCustomEvent extends CustomEventInterstitial {
    ...
    protected void loadInterstitial(Context context, CustomEventInterstitialListener interstitialListener,
        ...
        if (context != null && context instanceof Activity) {
            ...
            MoPubLog.log(MoPubLog.SdkLogEvent.ERROR, TAG, "Context not an Activity. Returning error!");
        ...
        iMInterstitial = new InMobiInterstitial(activity, placementId, new InterstitialAdEventListener() {
            ...
            public void onAdLoadSucceeded(InMobiInterstitial inMobiInterstitial) {
                ...
                MoPubLog.log(MoPubLog.AdapterLogEvent.CUSTOM, TAG, "InMobi interstitial ad loaded successfully.");
            ...
            public void onAdLoadFailed(InMobiInterstitial inMobiInterstitial, InMobiAdRequestStatus inMobiAdRequestStatus) {
                ...
                MoPubLog.log(MoPubLog.AdapterLogEvent.CUSTOM, TAG, "InMobi interstitial ad failed to load.");
                if (mInterstitialListener != null) {
            ...
            public void onAdClicked(InMobiInterstitial inMobiInterstitial, Map<Object, Object> params) {
                ...
                MoPubLog.log(MoPubLog.AdapterLogEvent.CUSTOM, TAG, "InMobi interstitial interaction happening.");
                if (mInterstitialListener != null) {
            ...
            public void onAdWillDisplay(InMobiInterstitial inMobiInterstitial) {
                ...
                MoPubLog.log(MoPubLog.AdapterLogEvent.CUSTOM, TAG, "Interstitial ad will display.");
            }

            @Override
            public void onAdDisplayed(InMobiInterstitial inMobiInterstitial) {
                super.onAdDisplayed(inMobiInterstitial);
                MoPubLog.log(MoPubLog.AdapterLogEvent.CUSTOM, TAG, "InMobi interstitial show on screen.");
                if (mInterstitialListener != null) {
            ...
            public void onAdDisplayFailed(InMobiInterstitial inMobiInterstitial) {
                ...
                MoPubLog.log(MoPubLog.AdapterLogEvent.CUSTOM, TAG, "Interstitial ad failed to display.");
            }

            @Override
            public void onAdDismissed(InMobiInterstitial inMobiInterstitial) {
                super.onAdDismissed(inMobiInterstitial);
                if (null != mInterstitialListener) {
            ...
            public void onRewardsUnlocked(InMobiInterstitial inMobiInterstitial, Map<Object, Object> rewards) {
                MoPubLog.log(MoPubLog.AdapterLogEvent.CUSTOM, TAG, "InMobi interstitial onRewardsUnlocked.");
